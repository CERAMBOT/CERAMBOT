...
#define STRING_CONFIG_H_AUTHOR "(Jony, cerambot)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "CERAMBOT"
...
#define DELTA
  ...
  #define DELTA_HEIGHT 308.5 // get this value from auto calibrate
